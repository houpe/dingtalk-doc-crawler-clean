...
当用户认为问题件预处罚中的超时单存在歧义，需要在规定时间内发起举证申诉时，可参考本文操作。

## 前置条件

- 已登录相关系统账号。
- 账号具备查看问题件预处罚及发起申诉的权限。
- 需要申诉的超时单仍在可申诉时效内。
...
- 在 **72小时内（当前时间-创建时间）** 发起申诉后，申诉单进入后续处理流程。
- 超时未申诉时，该条申诉单会自动完结，并完成处罚。

## 注意事项

::: danger 重点提醒
- 申诉时效为 **72小时内（当前时间-创建时间）**。
- 超时未申诉的申诉单会自动完结并完成处罚。
:::
...
**Q：超过 72 小时还能申诉吗？**
A：原文规则为用户可在 **72小时内（当前时间-创建时间）** 发起申诉；如超时未申诉，该条申诉单自动完结并完成处罚。