...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_10_e94b96dc.png)

#### (2) 导入库位

如果仓库已有库位编码体系，推荐使用导入方式批量导入。操作步骤：在库位管理页面点击"导入"按钮，下载导入模板，按模板格式填写库位信息后上传。模板内容包括：库位编码、所属库区、库位类型、巷道编码、动线号等字段。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_11_e213f0ae.png)

<strong>查看导入结果</strong>：导入完成后系统会显示导入结果汇总，包含成功条数和失败条数。如存在失败记录，可下载失败明细查看具体原因（常见原因：库位编码重复、库区不存在、必填字段为空等），修正后重新导入。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_12_4b5dcb0d.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_13_2ccb6f1a.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_14_457f7d24.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_15_7567dfc0.png)

#### (3) SKU档案中需要注意的配置

在SKU档案编辑页面中，以下配置项需要重点关注：行业属性（决定收货时是否需要采集批次/效期）、ABC分类（影响库位定位匹配）、单位尺寸和重量（用于推荐包材和校验库位容量）、托规（决定上架时的托盘拆分）、包装单位条码（支持多级条码收货）。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_16_ef5e73cc.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_17_9cc56e8f.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_18_42ee3433.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_19_730c34e3.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_1_68925fe0.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_20_e59e47f8.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_2_5e45b2a3.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_3_925b7af9.png)

<strong>快速上架功能</strong>：PDA收货后立即进入上架环节，扫描或选择推荐库位立即完成上架，省去先收货再领取上架任务的两步操作，大幅提升效率。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_4_211d769e.png)

#### (4) 收货记录与自动定位

<strong>系统功能路径</strong>：入库 → 收货记录

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_5_1bc99e39.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_6_464c1e9c.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_7_1a9ea66b.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_8_11d55e9c.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/01_创建仓库、货主、员工_操作说明书_9_c1a2da40.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_10_587285e7.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_11_47624174.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_12_df33ca37.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_13_72da43aa.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_14_541ce010.png)

<strong>方式二：包裹汇单-加入波次</strong>

包裹汇单支持多维度筛选汇总：按承运公司、货主、收件省等维度汇总包裹，便于批量打单（不同承运公司指向不同打印机）、便于不同承运公司包裹分堆存放与交接。支持批量拆包、批量指定包装方案。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_15_72da43aa.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_16_17c2827e.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_17_efc69466.png)

可使用"分配库位"预分配功能提前占库，根据分配库区区域筛选包裹汇波。可将每次筛选条件保存便于下次引用。

波次单会自动运行：分配库存 → 分组 → 创建拣货任务。波次默认锁定，此时仍可审单、拦截。确认无误后需释放波次才可执行拣选任务。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_18_48dcac0b.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_19_9db39793.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_1_6a0aed3f.png)

#### (7) 拣货任务

<strong>系统功能路径</strong>：出库 → 拣货任务

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_20_4e4d4b2c.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_21_ffe6ff4c.png)

#### (9) 纸质单拣货

打印拣货单 → 线下完成拣货 → 回到电脑端确认任务。目前必须从分配库位拣货。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_22_c82e85d1.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_23_3cc0b891.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_24_6006dbd8.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_25_042106a2.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_26_4432fa4c.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_27_22f60eb8.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_28_f5f4853b.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_2_f5ddcdaf.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_3_7eb3cb08.png)

<strong>批量复核</strong>：与普通复核的主要差别——有拦截订单需确认并踢出；完成一单后自动完成同波其他订单；不能拆包。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_4_ab9172e0.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_5_3ef4c675.png)

<strong>批量称重</strong>：仅针对批量波次，称重一单后整个波次完成。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_6_b1be23a0.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_7_dafabdc8.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_8_215295e4.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/02_创建库位、SKU_操作说明书_9_45d78a45.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_10_4496a847.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_11_a732f9bf.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_12_73f8931f.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_13_cefd321c.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_14_bc65de06.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_15_5360d0fa.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_16_dfd0fa01.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_1_cbf6d08f.png)

#### (2) 拆包规则

<strong>系统功能路径</strong>：配置 → 拆包规则

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_2_45d9fbc4.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_3_4c6fcf96.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_4_bc776e69.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_5_aef152cd.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_6_69b09403.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_7_5808b053.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_8_758a083a.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/03_仓库初始配置（面向仓库）_操作说明书_9_ff39a72a.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_10_9764902e.png)

#### (2) 打印管理

首次使用WCS配置：①下载打印模板（PC端更新后需下载到WCS）；②将模板指向打印机并保存设置（不指向则每次弹窗手动选择打印机）。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_11_9e6df22a.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_12_8afbbc7b.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_13_bae1e4c0.png)

#### (2) 创建自定义导出模板

仓库如需自定义导出模板，通过"配置-导入导出模板"新建属于自己的模板。可自定义导出的字段、格式和排序方式。

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_14_e1ffe2b0.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_15_35a79b73.png)
...
![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_16_c327f3b0.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_17_92365a99.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_18_0a30efff.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_19_60b48f0e.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_1_07bd5ab9.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_20_df7cf6dd.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_21_a897b52b.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_22_0c39116a.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_23_a1c209e4.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_24_cdee7c0e.png)

![](./images/kDnRL6jAJMqmrjzKsqxpoZw6JyMoPYe1/04_配置规则策略_操作说明书_25_bfe348ef.png)
