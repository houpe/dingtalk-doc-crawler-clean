...
2. **普通工单查询**：支持处理工单，可进行**暂存**或**完结**。
3. **工单申诉**：支持**72小时**内未申诉单申诉。
...
1. 进入工单处理页面，查看**待处理**数量。

   **待处理**为：普通工单待处理 + 普通工单申诉单待处理总和。

2. 在列表中找到需要处理的工单，点击操作列的**处理**。
...
2. 查看或选择**处理网点**。
   ...
   **处理网点**会自动带出运单轨迹机构，并默认选择工单类型配置所对应的处理网点（寄件网点/目的网点）。也可通过自选网点查询后进行推送处理。
...
1. 网点处理普通工单后，工单可被**暂存**或**完结**。
2. 网点提交申诉后，申诉单流转至总部，由总部进行审核裁定。
3. 总部录入**普通工单**后，工单可流转至处理网点。
4. 总部录入**咨询工单**后，仅记录，不做后续网点流转处理。
