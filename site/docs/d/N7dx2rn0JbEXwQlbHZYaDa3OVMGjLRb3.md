...
![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_10_e94b96dc.png)
...
![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_11_e213f0ae.png)

10. <strong>包裹汇单，选择波次规则，组波</strong>

选择波次规则，可使用预分配功能根据库区区域汇波。

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_12_4b5dcb0d.png)

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_13_2ccb6f1a.png)

11. <strong>波次汇单 — 所见即所得</strong>

波次汇单页面可看到创建波次结果，所见即所得。波次会自动运行：分配 → 分组 → 创建拣货任务。

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_14_457f7d24.png)

12. <strong>释放波次</strong>

波次默认处于锁定状态，此时仍可审单、拦截。确认无误后，需要释放波次，才可执行对应拣选任务。

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_15_7567dfc0.png)
...
![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_16_ef5e73cc.png)

#### (1) 方式一：纸质单拣货

打印拣货单，线下完成拣货后，回到电脑端确认拣货任务。

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_17_9cc56e8f.png)
...
![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_18_42ee3433.png)

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_19_730c34e3.png)

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_1_68925fe0.png)
...
|----------|----------|----------|----------|
| 1 | 领取面单 | 3楼打单送到4楼，仅3个货主试运行新系统 | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_20_e59e47f8.png) |
| 2 | 根据面单序号分配到拣选车框 | 需要核对面单序号和框编号 | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_2_5e45b2a3.png) |
| 3 | 打开散单拣货 | | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_3_925b7af9.png) |
| 4 | 扫描运单号 | 扫描运单号可查询拣货任务 | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_4_211d769e.png) |
| 5 | 领取拣货任务 | 先领取 | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_5_1bc99e39.png) |
| 6 | 扫描库位 | 边拣边分，按照拣货顺序先引导到第一个拣货库位 | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_6_464c1e9c.png) |
...
| 14 | 拣选足够数量，并分播到每个拣选框 | | |
| 15 | 提交 | | |
| 16 | 直到完成拣选 | | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_7_1a9ea66b.png) |
...
![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_8_11d55e9c.png)

工作台号来源：容器类型-基本类型-工作台（使用环节-出库）；工作台配置。

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/01_创建仓库、货主、员工_操作说明书_9_c1a2da40.png)

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_10_587285e7.png)
...
![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_11_47624174.png)

#### (3) 复核作业流程

| <strong>序号</strong> | <strong>流程</strong> | <strong>说明</strong> | <strong>页面截图</strong> |
|----------|----------|----------|----------------|
| 1 | 打开普通复核扫描容器进入复核页面 | | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_12_df33ca37.png) |
| 2 | 关联打包员 | | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_13_72da43aa.png) |
| 3 | 扫描面单（后置打单可扫任务号/容器/波次号/包裹号）定位某一包裹 | | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_14_541ce010.png) |
| 4 | 逐件扫描货品 | | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_15_72da43aa.png) |
| 5 | 扫描箱型 | | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_16_17c2827e.png) |
| 6 | 自动完成该单复核（后置打单则自动打印面单） | | |
| 7 | 操作打包 | | ![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_17_efc69466.png) |
| 8 | 贴单 | | |
...
![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_18_48dcac0b.png)

#### (2) 批量称重

仅针对批量波次，称重一单后整个波次完成。

![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_19_9db39793.png)
...
![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_1_6a0aed3f.png)
...
![](./images/N7dx2rn0JbEXwQlbHZYaDa3OVMGjLRb3/02_创建库位、SKU_操作说明书_20_4e4d4b2c.png)
