...
网点的整车业务需要通过网络货运找车时，需要先在**中通冷运网络货运平台**完成**货主注册**。

## 前置条件

- **账号与权限要求**：账号权限角色需包含**中通冷运租户权限**，例如：**网点/省公司**。若无权限，请联系系统管理员。
- **设备与环境要求**：准备一台可以联网的电脑，建议使用 **Chrome 浏览器**。
...
**顶部 tab 切换至【中通冷运】 -> 左侧边栏【基础资料】->【货主管理】->【企业货主】**
...
- 货主资料提交后，进入平台审核流程。
- 审核通过后，可继续维护**开票信息管理**中的税务信息。
- 税务信息维护完成后，可用于后续开票相关操作。
...
**Q1：我作为货主，如何清楚知道需要做哪些事情？**

A：点击侧边栏**【货主首页】**，再点击**【货主首页】**，可以查看货主主要功能以及操作流程。根据页面流程和操作引导完成货主操作即可。